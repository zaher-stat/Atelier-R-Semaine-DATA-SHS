...
L'objectif de cette démonstration est d'illustrer l'un des des usages potentiels de R.
...
Il s'agit donc de créer [un code R](https://github.com/zaher-stat/Atelier-R-Semaine-DATA-SHS/blob/ZAHER_Ahmed/dashboard.Rmd) qui permet de visualiser en temps réel un tableau de bord (*dashboard*) qui présente les résultats. 
